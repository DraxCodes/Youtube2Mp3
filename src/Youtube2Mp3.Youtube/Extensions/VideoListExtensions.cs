...
{
    public static class VideoListExtensions
    {
        public static Video GetByTitleSingle(this IReadOnlyList<Video> videos, string title)
        {
            return videos.FirstOrDefault(v => v.Title.Contains(title));
        }

        public static IEnumerable<Video> GetByTitleMany(this IReadOnlyList<Video> videos, string title)
        {
